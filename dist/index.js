...
var require_lib = __commonJS({
  "node_modules/@actions/http-client/lib/index.js"(exports) {
    ...
    var HttpClient = class {
      ...
      request(verb, requestUrl, data3, headers2) {
        return __awaiter(this, void 0, void 0, function* () {
          if (this._disposed) {
          ...
          let response;
          do {
            response = yield this.requestRaw(info, data3);
            if (response && response.message && response.message.statusCode === HttpCodes.Unauthorized) {
              ...
              if (authenticationHandler) {
                return authenticationHandler.handleAuthentication(this, info, data3);
              } else {
                return response;
              }
            }
      ...
      requestRaw(info, data3) {
        return __awaiter(this, void 0, void 0, function* () {
          return new Promise((resolve, reject) => {
            ...
            this.requestRawWithCallback(info, data3, callbackForResult);
          });
        });
      }
      requestRawWithCallback(info, data3, onResult) {
        if (typeof data3 === "string") {
          if (!info.options.headers) {
            info.options.headers = {};
          }
          info.options.headers["Content-Length"] = Buffer.byteLength(data3, "utf8");
        }
      ...
      _prepareRequest(method2, requestUrl, headers2) {
        const info = {};
      ...
      addTable(rows) {
        const tableBody = rows.map((row) => {
          const cells = row.map((cell) => {
            ...
            return this.wrap(tag, data3, attrs);
          }).join("");
...
var require_follow_redirects = __commonJS({
  "node_modules/follow-redirects/index.js"(exports, module2) {
    ...
    RedirectableRequest.prototype.write = function(data3, encoding, callback) {
      ...
      if (!isString(data3) && !isBuffer(data3)) {
...
var require_axios = __commonJS({
  "node_modules/axios/dist/node/axios.cjs"(exports, module2) {
    ...
    function toFormData(obj, formData2, options) {
      ...
      formData2 = formData2 || new (FormData__default["default"] || FormData)();
      ...
      const useBlob = _Blob && isSpecCompliant(formData2);
        ...
        if (value && !path && typeof value === "object") {
          if (utils.endsWith(key, "{}")) {
            ...
            arr.forEach(function each(el, index) {
              !(utils.isUndefined(el) || el === null) && formData2.append(
    ...
    function formDataToJSON(formData2) {
      ...
      if (utils.isFormData(formData2) && utils.isFunction(formData2.entries)) {
        const obj = {};
        utils.forEachEntry(formData2, (name, value) => {
    ...
    function AxiosHeaders(headers2, defaults2) {
    ...
    Object.assign(AxiosHeaders.prototype, {
      ...
      normalize: function(format) {
        ...
        utils.forEach(this, (value, header) => {
          const key = findKey(headers2, header);
          if (key) {
    ...
    function httpAdapter(config) {
      return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
        ...
        if (protocol === "data:") {
          ...
          if (responseType === "text") {
            ...
            if (!responseEncoding || responseEncoding === "utf8") {
              data3 = utils.stripBOM(convertedData);
            }
        ...
        const headers2 = AxiosHeaders.from(config.headers).normalize();
        ...
        if (utils.isFormData(data3) && utils.isFunction(data3.getHeaders)) {
          headers2.set(data3.getHeaders());
        } else if (data3 && !utils.isStream(data3)) {
          if (Buffer.isBuffer(data3))
            ;
          else if (utils.isArrayBuffer(data3)) {
            data3 = Buffer.from(new Uint8Array(data3));
          } else if (utils.isString(data3)) {
            data3 = Buffer.from(data3, "utf-8");
          } else {
            return reject(new AxiosError(
          ...
          headers2.set("Content-Length", data3.length, false);
          if (config.maxBodyLength > -1 && data3.length > config.maxBodyLength) {
            return reject(new AxiosError(
              "Request body larger than maxBodyLength limit",
              AxiosError.ERR_BAD_REQUEST,
              config
        ...
        const contentLength = +headers2.getContentLength();
        ...
        if (data3 && (onUploadProgress || maxUploadRate)) {
          if (!utils.isStream(data3)) {
            data3 = stream__default["default"].Readable.from(data3, { objectMode: false });
          }
          data3 = stream__default["default"].pipeline([data3, new AxiosTransformStream({
            length: utils.toFiniteNumber(contentLength),
            maxRate: utils.toFiniteNumber(maxUploadRate)
          })], utils.noop);
          onUploadProgress && data3.on("progress", (progress) => {
        ...
        headers2.set("Accept-Encoding", "gzip, deflate, br", false);
        const options = {
          path,
          method: method2,
        ...
        req = transport.request(options, function handleResponse(res) {
          ...
          if (config.decompress !== false) {
            if (data3 && data3.length === 0 && res.headers["content-encoding"]) {
    ...
    var defaults = {
      ...
      transformRequest: [function transformRequest(data3, headers2) {
        const contentType = headers2.getContentType() || "";
        const hasJSONContentType = contentType.indexOf("application/json") > -1;
        const isObjectPayload = utils.isObject(data3);
        if (isObjectPayload && utils.isHTMLForm(data3)) {
          data3 = new FormData(data3);
        }
        const isFormData2 = utils.isFormData(data3);
        if (isFormData2) {
        ...
        if (utils.isArrayBuffer(data3) || utils.isBuffer(data3) || utils.isStream(data3) || utils.isFile(data3) || utils.isBlob(data3)) {
          return data3;
        }
        if (utils.isArrayBufferView(data3)) {
          return data3.buffer;
        }
        if (utils.isURLSearchParams(data3)) {
        ...
        if (isObjectPayload) {
          ...
          if ((isFileList2 = utils.isFileList(data3)) || contentType.indexOf("multipart/form-data") > -1) {
      ...
      transformResponse: [function transformResponse(data3) {
        ...
        if (data3 && utils.isString(data3) && (forcedJSONParsing && !this.responseType || JSONRequested)) {
    ...
    function transformData(fns, response) {
      ...
      const headers2 = AxiosHeaders.from(context.headers);
      let data3 = context.data;
      utils.forEach(fns, function transform(fn) {
        data3 = fn.call(config, data3, headers2.normalize(), response ? response.status : void 0);
      });
      headers2.normalize();
      return data3;
    }
    ...
    var Axios = class {
      constructor(instanceConfig2) {
        this.defaults = instanceConfig2;
        this.interceptors = {
    ...
    utils.forEach(["delete", "get", "head", "options"], function forEachMethodNoData(method2) {
      Axios.prototype[method2] = function(url2, config) {
    ...
    function createInstance(defaultConfig) {
      ...
      instance.create = function create(instanceConfig2) {
        return createInstance(mergeConfig(defaultConfig, instanceConfig2));
      };
      return instance;
    }
...
var require_httpClient = __commonJS({
  "src/httpClient.js"(exports, module2) {
    "use strict";
    ...
    var url = require("url");
    var METHOD_GET = "GET";
    var METHOD_POST2 = "POST";
    var HEADER_CONTENT_TYPE = "Content-Type";
    var CONTENT_TYPE_URLENCODED = "application/x-www-form-urlencoded";
    var request2 = async ({ method: method2, instanceConfig: instanceConfig2, data: data3, files: files3, file: file2, actions, ignoredCodes: ignoredCodes2, preventFailureOnNoResponse: preventFailureOnNoResponse2, escapeData: escapeData2 }) => {
      try {
        if (escapeData2) {
          data3 = data3.replace(/"[^"]*"/g, (match) => {
            return match.replace(/[\n\r]\s*/g, "\\n");
          });
        }
        if (method2 === METHOD_GET) {
          data3 = void 0;
        }
        if (files3 && files3 !== "{}") {
          let filesJson = convertToJSON(files3);
          let dataJson = convertToJSON(data3);
          if (Object.keys(filesJson).length > 0) {
            try {
              data3 = convertToFormData(dataJson, filesJson);
              instanceConfig2 = await updateConfig(instanceConfig2, data3, actions);
            } catch (error) {
        ...
        if ((!data3 || data3 === "{}") && (!files3 || files3 === "{}") && file2) {
          data3 = fs.createReadStream(file2);
          updateConfigForFile(instanceConfig2, file2, actions);
        }
        if (instanceConfig2.headers[HEADER_CONTENT_TYPE] === CONTENT_TYPE_URLENCODED) {
          let dataJson = convertToJSON(data3);
          if (typeof dataJson === "object") {
            data3 = new url.URLSearchParams(dataJson).toString();
          }
        }
        const requestData = {
          method: method2,
        ...
        actions.debug("Instance Configuration: " + JSON.stringify(instanceConfig2));
        const instance = axios2.create(instanceConfig2);
        ...
        if (error.response && ignoredCodes2.includes(error.response.status)) {
        ...
        } else if (error.request && !preventFailureOnNoResponse2) {
          actions.setFailed(JSON.stringify({ error: "no response received" }));
        } else if (error.request && preventFailureOnNoResponse2) {
          actions.warning(JSON.stringify(error));
        } else {
          actions.setFailed(JSON.stringify({ message: error.message, data: data3 }));
        }
      }
    };
    var convertToJSON = (value) => {
      try {
    ...
    var convertToFormData = (data3, files3) => {
      formData = new FormData2();
      for (const [key, value] of Object.entries(data3)) {
        formData.append(key, value);
      }
      for (const [key, value] of Object.entries(files3)) {
        formData.append(key, fs.createReadStream(value));
      }
      return formData;
    };
    var updateConfig = async (instanceConfig2, formData2, actions) => {
      try {
        const formHeaders = formData2.getHeaders();
        const contentType = formHeaders["content-type"];
        delete formHeaders["content-type"];
        return {
          ...instanceConfig2,
          headers: {
            ...instanceConfig2.headers,
            ...formHeaders,
            "Content-Length": await contentLength(formData2),
    ...
    var updateConfigForFile = (instanceConfig2, filePath, actions) => {
      try {
    ...
    var contentLength = (formData2) => new Promise((resolve, reject) => {
...
var require_githubActions = __commonJS({
  "src/githubActions.js"(exports, module2) {
    "use strict";
    var core2 = require_core();
    var GithubActions2 = class {
      debug(message) {
        core2.debug(message);
      }
      warning(message) {
      ...
      setOutput(name, output) {
        core2.setOutput(name, output);
      }
      setFailed(message) {
        core2.setFailed(message);
      }
    };
    var LogActions = class {
      debug(message) {
    ...
    module2.exports = { GithubActions: GithubActions2, LogActions };
  }
});
...
var { request, METHOD_POST } = require_httpClient();
var { GithubActions } = require_githubActions();
var customHeaders = {};
...
var headers = { "Content-Type": core.getInput("contentType") || "application/json" };
if (!!core.getInput("bearerToken")) {
  headers["Authorization"] = `Bearer ${core.getInput("bearerToken")}`;
}
var instanceConfig = {
  baseURL: core.getInput("url", { required: true }),
  timeout: parseInt(core.getInput("timeout") || 5e3, 10),
...
var data2 = core.getInput("data") || "{}";
var files2 = core.getInput("files") || "{}";
var file = core.getInput("file");
var method = core.getInput("method") || METHOD_POST;
var preventFailureOnNoResponse = core.getInput("preventFailureOnNoResponse") === "true";
var escapeData = core.getInput("escapeData") === "true";
var ignoreStatusCodes = core.getInput("ignoreStatusCodes");
var ignoredCodes = [];
